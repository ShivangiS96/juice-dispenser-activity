...
#Label Select Fruit
label_name = Label(root, text="Please select your fruit ",bg="pink", font=("Bahnschrift Light",15))
...
label_quantity = Label(root, text="Enter any quantity you want ",bg="red", font=("Bahnschrift Light",15))
...
#Total Cost Label
label_show_amount = Label(root ,bg="purple", font=("Bahnschrift Light",12))
label_show_amount.place(relx=0.95,rely=0.7, anchor= E)
#Quantity Label
label_show_quantity = Label(root ,bg="green", font=("Bahnschrift Light",12))
